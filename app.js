...
const REEL_QUOTES = [
  /* ☀️ Good Morning (20) */
  { g: 'gm', ta: 'காலை வணக்கம்! 🌞 இன்று உங்கள் நாள் சேலை மாதிரி அழகாக அமையட்டும்!', te: 'శుభోదయం! 🌞 ఈరోజు మీ రోజు చీర లాగా అందంగా సాగాలి!', kn: 'ಶುಭೋದಯ! 🌞 ಇಂದು ನಿಮ್ಮ ದಿನ ಸೀರೆಯಂತೆ ಅಂದವಾಗಿ ಸಾಗಲಿ!', en: 'Good morning! 🌞 May your day unfold beautifully, just like a saree!' },
  { g: 'gm', ta: 'அழகான காலை... அழகான சேலை... இன்றைய நாள் இனிமையாக இருக்கட்டும்! ✨', te: 'అందమైన ఉదయం... అందమైన చీర... ఈరోజు ఇంపుగా ఉండాలి! ✨', kn: 'ಅಂದವಾದ ಬೆಳಗು... ಅಂದವಾದ ಸೀರೆ... ಇಂದು ಇಂಪಾಗಿರಲಿ! ✨', en: 'A beautiful morning... a beautiful saree... may today be sweet! ✨' },
  { g: 'gm', ta: 'சூரியன் எழுந்தது போல... உங்கள் முகத்திலும் புன்னகை மலரட்டும்! 🌼', te: 'సూర్యుడు ఉదయించినట్టే... మీ ముఖంలో చిరునవ్వు వికసించాలి! 🌼', kn: 'ಸೂರ್ಯ ಉದಿಸಿದಂತೆ... ನಿಮ್ಮ ಮುಖದಲ್ಲಿ ನಗು ಅರಳಲಿ! 🌼', en: 'Like the rising sun... may a smile bloom on your face! 🌼' },
  { g: 'gm', ta: 'ஒவ்வொரு காலையும் ஒவ்வொரு புது தொடக்கம்! இனிய காலை வணக்கம் ☀️', te: 'ప్రతి ఉదయం ఒక కొత్త ప్రారంభం! శుభోదయం ☀️', kn: 'ಪ್ರತಿ ಬೆಳಗು ಒಂದು ಹೊಸ ಆರಂಭ! ಶುಭೋದಯ ☀️', en: 'Every morning is a new beginning! Good morning ☀️' },
  { g: 'gm', ta: 'காலை வணக்கம்! இன்றைய அழகில் நீங்கள் தான் ஃபர்ஸ்ட்! 💐', te: 'శుభోదయం! ఈరోజు అందంలో మీరే ఫస్ట్! 💐', kn: 'ಶುಭೋದಯ! ಇಂದಿನ ಅಂದದಲ್ಲಿ ನೀವೇ ಫಸ್ಟ್! 💐', en: 'Good morning! In today’s beauty, you come first! 🎐' },
  { g: 'gm', ta: 'பொன்னான காலை வணக்கம் 🌻 உங்கள் நாள் தங்கம் போல பிரகாசிக்கட்டும்!', te: 'బంగారు ఉదయ వందనాలు 🌻 మీ రోజు బంగారంలా మెరవాలి!', kn: 'ಚಿನ್ನದ ಬೆಳಗಿನ ವಂದನೆ 🌻 ನಿಮ್ಮ ದಿನ ಚಿನ್ನದಂತೆ ಹೊಳೆಯಲಿ!', en: 'A golden good morning 🌻 May your day shine like gold!' },
  { g: 'gm', ta: 'விடிந்தால் விஷயம் இருக்கு — இன்று நல்ல நாள்! காலை வணக்கம் 🌄', te: 'తెల్లవారింది అంటే విషయం ఉంది — ఈరోజు మంచి రోజు! 🌄', kn: 'ಬೆಳಗಾಯಿತು ಅಂದರೆ ವಿಷಯ ಇದೆ — ಇಂದು ಒಳ್ಳೆಯ ದಿನ! 🌄', en: 'Dawn brings promise — today will be a good day! Good morning 🌄' },
  { g: 'gm', ta: 'காலை வணக்கம்! காபி கசப்பா இருந்தாலும் நாள் இனிக்கட்டும் ☕✨', te: 'శుభోదయం! కాఫీ చేదుగా ఉన్నా రోజు తీపిగా ఉండాలి ☕✨', kn: 'ಶುಭೋದಯ! ಕಾಫಿ ಕಹಿಯಿದ್ದರೂ ದಿನ ಸಿಹಿಯಾಗಿರಲಿ ☕✨', en: 'Good morning! Even if the coffee is bitter, may your day be sweet ☕✨' },
  { g: 'gm', ta: 'இனிய காலை! புது மலர் போல புத்துணர்ச்சியா இருங்கள்! 🌸', te: 'ఇంపైన ఉదయం! కొత్త పువ్వులా చైతన్యంగా ఉండండి! 🌸', kn: 'ಇಂಪಾದ ಬೆಳಗು! ಹೊಸ ಹೂವಿನಂತೆ ಉತ್ಸಾಹದಿಂದ ಇರಿ! 🌸', en: 'Sweet morning! Stay fresh like a new flower! 🌸' },
  { g: 'gm', ta: 'காலை வணக்கம்! இன்று ஒரு அழகான சேலை உங்களை காத்திருக்கிறது 🥻', te: 'శుభోదయం! ఈరోజు ఒక అందమైన చీర మిమ్మల్ని వేచి ఉంది 🥻', kn: 'ಶುಭೋದಯ! ಇಂದು ಒಂದು ಅಂದವಾದ ಸೀರೆ ನಿಮ್ಮನ್ನು ಕಾಯುತ್ತಿದೆ 🥻', en: 'Good morning! A beautiful saree is waiting for you today 🦻' },
  { g: 'gm', ta: 'மலர் மணம் மாதிரி இனிய காலை வணக்கம்! 🌺', te: 'పువ్వు సువాసన లాగా ఇంపైన శుభోదయం! 🌺', kn: 'ಹೂವಿನ ಸುಗಂಧದಂತೆ ಇಂಪಾದ ಶುಭೋದಯ! 🌺', en: 'A sweet good morning, like the scent of flowers! 🌺' },
  { g: 'gm', ta: 'காலை வணக்கம்! இன்றைய சூரிய ஒளி உங்கள் மனசுக்கும் தெரியட்டும்! 🌞', te: 'శుభోదయం! ఈరోజు సూర్యకాంతి మీ మనసుకు కూడా తగలాలి! 🌞', kn: 'ಶುಭೋದಯ! ಇಂದಿನ ಸೂರ್ಯಬೆಳಕು ನಿಮ್ಮ ಮನಸಿಗೂ ತಟ್ಟಲಿ! 🌞', en: 'Good morning! May today’s sunshine reach your heart too! 🌞' },
  { g: 'gm', ta: 'நல்ல காலை! நல்ல எண்ணங்கள் பொறிக்கட்டும் 💭✨', te: 'మంచి ఉదయం! మంచి ఆలోచనలు మొలకెత్తాలి 💭✨', kn: 'ಒಳ್ಳೆಯ ಬೆಳಿಗ್ಗೆ! ಒಳ್ಳೆಯ ಯೋಚನೆಗಳು ಮೊಳೆಯಲಿ 💭✨', en: 'Good morning! May good thoughts blossom 💭✨' },
  { g: 'gm', ta: 'காலை வணக்கம்! இன்று உங்கள் புன்னகையால் யாரையாவது மகிழ்வியுங்கள் 😊', te: 'శుభోదయం! ఈరోజు మీ చిరునవ్వుతో ఎవరినైనా సంతోషపెట్టండి 😊', kn: 'ಶುಭೋದಯ! ಇಂದು ನಿಮ್ಮ ನಗುವಿನಿಂದ ಯಾರನ್ನಾದರೂ ಸಂತೋಷಪಡಿಸಿ 😊', en: 'Good morning! Make someone smile with yours today 😊' },
  { g: 'gm', ta: 'விடியல் பொழுது வணக்கம்! புது நம்பிக்கை பொறிக்கட்டும் 🌅', te: 'వేకువ వేళ వందనాలు! కొత్త నమ్మకం మొలకెత్తాలి 🌅', kn: 'ಬೆಳಗಿನ ವೇಳೆಯ ವಂದನೆ! ಹೊಸ ನಂಬಿಕೆ ಮೊಳೆಯಲಿ 🌅', en: 'Greetings at dawn! May new hope blossom 🌅' },
  { g: 'gm', ta: 'காலை வணக்கம்! அழகான நாள், அழகான ஆரம்பம் ✨', te: 'శుభోదయం! అందమైన రోజు, అందమైన ప్రారంభం ✨', kn: 'ಶುಭೋದಯ! ಅಂದವಾದ ದಿನ, ಅಂದವಾದ ಆರಂಭ ✨', en: 'Good morning! A beautiful day, a beautiful start ✨' },
  { g: 'gm', ta: 'தேன் இனிப்பு காலை வணக்கம்! 🍯 உங்கள் நாள் தேன் மாதிரி இனிக்கட்டும்!', te: 'తేనె ఇంపు శుభోదయం! 🍯 మీ రోజు తేనెలా తీపిగా ఉండాలి!', kn: 'ಜೇನು ಸಿಹಿಯ ಶುಭೋದಯ! 🍯 ನಿಮ್ಮ ದಿನ ಜೇನಿನಂತೆ ಸಿಹಿಯಾಗಿರಲಿ!', en: 'A honey-sweet good morning! 🍯 May your day be as sweet as honey!' },
  { g: 'gm', ta: 'காலை வணக்கம்! இன்று உங்களுக்கு நல்லதே நடக்கட்டும் 🙏', te: 'శుభోదయం! ఈరోజు మీకు మంచిదే జరగాలి 🙏', kn: 'ಶುಭೋದಯ! ಇಂದು ನಿಮಗೆ ಒಳ್ಳೆಯದೇ ಆಗಲಿ 🙏', en: 'Good morning! May only good things come to you today 🙏' },
  { g: 'gm', ta: 'சுத்தமான காற்று, சுகமான காலை — இனிய வணக்கம்! 🍃', te: 'స్వచ్ఛమైన గాలి, హాయిగా ఉదయం — ఇంపైన వందనాలు! 🍃', kn: 'ಶುದ್ಧ ಗಾಳಿ, ಆರಾಮದ ಬೆಳಗು — ಇಂಪಾದ ವಂದನೆ! 🍃', en: 'Fresh air, a gentle morning — sweet greetings! 🍃' },
  { g: 'gm', ta: 'காலை வணக்கம்! நல்ல சேலை + நல்ல மூட் = பெர்ஃபெக்ட் டே! 🥻', te: 'శుభోదయం! మంచి చీర + మంచి మూడ్ = పర్‌ఫెక్ట్ డే! 🥻', kn: 'ಶುಭೋದಯ! ಒಳ್ಳೆಯ ಸೀರೆ + ಒಳ್ಳೆಯ ಮೂಡ್ = ಪರ್ಫೆಕ್ಟ್ ಡೇ! 🥻', en: 'Good morning! Nice saree + good mood = perfect day! 🦻' },
  /* 🌙 Good Night (16) */
  { g: 'gn', ta: 'இனிய இரவு வணக்கம் 🌙 நல்ல கனவுகள் தெரியட்டும்!', te: 'ఇంపైన రాత్రి వందనాలు 🌙 మంచి కలలు కావాలి!', kn: 'ಇಂಪಾದ ರಾತ್ರಿ ವಂದನೆ 🌙 ಒಳ್ಳೆಯ ಕನಸುಗಳು ಬರಲಿ!', en: 'Sweet good night 🌙 May good dreams visit you!' },
  { g: 'gn', ta: 'நல்ல இரவு! நாளை இன்னும் அழகான சேலையோட சந்திப்போம் 🌙✨', te: 'మంచి రాత్రి! రేపు మరింత అందమైన చీరతో కలుద్దాం 🌙✨', kn: 'ಒಳ್ಳೆಯ ರಾತ್ರಿ! ನಾಳೆ ಇನ್ನಷ್ಟು ಅಂದವಾದ ಸೀರೆಯೊಂದಿಗೆ ಭೇಟಿಯಾಗೋಣ 🌙✨', en: 'Good night! Tomorrow we meet an even more beautiful saree 🌙✨' },
  { g: 'gn', ta: 'நிலவு மாதிரி அமைதியான தூக்கம் வரட்டும்... Good Night 🌙', te: 'నెలలాగా ప్రశాంతమైన నిద్ర వస్తుంది... Good Night 🌙', kn: 'ಚಂದ್ರನಂತೆ ಶಾಂತವಾದ ನಿದ್ರೆ ಬರಲಿ... Good Night 🌙', en: 'May sleep be as peaceful as the moon... Good Night 🌙' },
  { g: 'gn', ta: 'இன்றைய சோர்வு எல்லாம் தூக்கத்தில் மறையட்டும்! இனிய இரவு ✨', te: 'ఈరోజు అలసట అంతా నిద్రలో మాయం కావాలి! ఇంపైన రాత్రి ✨', kn: 'ಇಂದಿನ ಆಯಾಸ ಎಲ್ಲವೂ ನಿದ್ರೆಯಲ್ಲಿ ಮರೆಯಾಗಲಿ! ಇಂಪಾದ ರಾತ್ರಿ ✨', en: 'May today’s tiredness vanish in your sleep! Sweet night ✨' },
  { g: 'gn', ta: 'கனவுகளில் அழகான சேலைகள் வரட்டும்... நல்ல இரவு 🌙', te: 'కలల్లో అందమైన చీరలు రావాలి... మంచి రాత్రి 🌙', kn: 'ಕನಸಿನಲ್ಲಿ ಅಂದವಾದ ಸೀರೆಗಳು ಬರಲಿ... ಒಳ್ಳೆಯ ರಾತ್ರಿ 🌙', en: 'May beautiful sarees visit your dreams... good night 🌙' },
  { g: 'gn', ta: 'இரவு வணக்கம்! நாளை ஒரு புது தினம்... புது வெற்றி 🌟', te: 'రాత్రి వందనాలు! రేపు కొత్త రోజు... కొత్త విజయం 🌟', kn: 'ರಾತ್ರಿ ವಂದನೆ! ನಾಳೆ ಹೊಸ ದಿನ... ಹೊಸ ಜಯ 🌟', en: 'Good night! Tomorrow is a new day... a new victory 🌟' },
  { g: 'gn', ta: 'நட்சத்திரங்கள் உங்கள் கனவுகளை காவல் காட்டும் ✨ Good Night!', te: 'నక్షత్రాలు మీ కలలను కాపాడతాయి ✨ Good Night!', kn: 'ನಕ್ಷತ್ರಗಳು ನಿಮ್ಮ ಕನಸುಗಳನ್ನು ಕಾಪಾಡುತ್ತವೆ ✨ Good Night!', en: 'The stars will guard your dreams ✨ Good Night!' },
  { g: 'gn', ta: 'இனிய இரவு! நாளை காலையில் புது ஆற்றலோட எழுந்திருங்கள் 🌅', te: 'ఇంపైన రాత్రి! రేపు ఉదయం కొత్త శక్తితో మేల్కొనండి 🌅', kn: 'ಇಂಪಾದ ರಾತ್ರಿ! ನಾಳೆ ಬೆಳಿಗ್ಗೆ ಹೊಸ ಶಕ್ತಿಯೊಂದಿಗೆ ಏಳಿ 🌅', en: 'Sweet night! Wake up tomorrow with fresh energy 🌅' },
  { g: 'gn', ta: 'தூங்குங்கள் அமைதியா... விழியுங்கள் வெற்றியா! நல்ல இரவு 🌙', te: 'ప్రశాంతంగా నిద్రించండి... విజయంతో మేల్కొనండి! మంచి రాత్రి 🌙', kn: 'ಶಾಂತವಾಗಿ ನಿದ್ರಿಸಿ... ವಿಜಯದೊಂದಿಗೆ ಏಳಿ! ಒಳ್ಳೆಯ ರಾತ್ರಿ 🌙', en: 'Sleep peacefully... wake up victorious! Good night 🌙' },
  { g: 'gn', ta: 'இரவு வணக்கம்! இன்றைய நினைவுகள் இனிமையா இருக்கட்டும் 💫', te: 'రాత్రి వందనాలు! ఈరోజు జ్ఞాపకాలు ఇంపుగా ఉండాలి 💫', kn: 'ರಾತ್ರಿ ವಂದನೆ! ಇಂದಿನ ನೆನಪುಗಳು ಇಂಪಾಗಿರಲಿ 💫', en: 'Good night! May today’s memories stay sweet 💫' },
  { g: 'gn', ta: 'நிலா ஒளியில் நல்ல தூக்கம்! Good Night 🌕', te: 'నెలవెలుతురులో మంచి నిద్ర! Good Night 🌕', kn: 'ಬೆಳದಿಂಗಳ ಬೆಳಕಿನಲ್ಲಿ ಒಳ್ಳೆಯ ನಿದ್ರೆ! Good Night 🌕', en: 'Sleep well in the moonlight! Good Night 🌕' },
  { g: 'gn', ta: 'இன்றைய கஷ்டம் எல்லாம் இரவில் மறக்கட்டும்... நாளை புது தொடக்கம் 🌙', te: 'ఈరోజు కష్టం అంతా రాత్రిలో మరచిపోవాలి... రేపు కొత్త ప్రారంభం 🌙', kn: 'ಇಂದಿನ ಕಷ್ಟ ಎಲ್ಲವೂ ರಾತ್ರಿಯಲ್ಲಿ ಮರೆತುಹೋಗಲಿ... ನಾಳೆ ಹೊಸ ಆರಂಭ 🌙', en: 'May today’s hardships fade into the night... tomorrow is a new beginning 🌙' },
  { g: 'gn', ta: 'இனிய இரவு வணக்கம்! மனசு நிம்மதியா தூங்கட்டும் ✨', te: 'ఇంపైన రాత్రి వందనాలు! మనసు ప్రశాంతంగా నిద్రించాలి ✨', kn: 'ಇಂಪಾದ ರಾತ್ರಿ ವಂದನೆ! ಮನಸ್ಸು ಶಾಂತವಾಗಿ ನಿದ್ರಿಸಲಿ ✨', en: 'Sweet good night! May your heart sleep in peace ✨' },
  { g: 'gn', ta: 'நல்ல இரவு! கனவுகளில் அழகான உலகம் இருக்கட்டும் 🌍💫', te: 'మంచి రాత్రి! కలల్లో అందమైన ప్రపంచం ఉండాలి 🌍💫', kn: 'ಒಳ್ಳೆಯ ರಾತ್ರಿ! ಕನಸಿನಲ್ಲಿ ಅಂದವಾದ ಜಗತ್ತಿರಲಿ 🌍💫', en: 'Good night! May your dreams hold a beautiful world 🌍F4AB' },
  { g: 'gn', ta: 'இரவு வணக்கம்! நாளை இன்னும் நல்லா இருக்கும் 🌟', te: 'రాత్రి వందనాలు! రేపు మరింత బాగుంటుంది 🌟', kn: 'ರಾತ್ರಿ ವಂದನೆ! ನಾಳೆ ಇನ್ನಷ್ಟು ಚೆನ್ನಾಗಿರುತ್ತದೆ 🌟', en: 'Good night! Tomorrow will be even better F31F' },
  { g: 'gn', ta: 'தூக்கம் தெய்வத்தோட சமம் — நல்லா தூங்குங்கள் 😴', te: 'నిద్ర దేవతతో సమానం — బాగా నిద్రించండి 😴', kn: 'ನಿದ್ರೆ ದೇವರಿಗೆ ಸಮಾನ — ಚೆನ್ನಾಗಿ ನಿದ್ರಿಸಿ 😴', en: 'Sleep is as good as prayer — sleep well 😴' },
  /* 🧵 தத்துவம் / Wisdom (34) */
  { g: 'th', ta: 'சேலை ஒரு உடை அல்ல — அது ஒரு தலைமுறையின் கதை 🧵', te: 'చీర ఒక వస్త్రం కాదు — అది ఒక తరానికి కథ 🧵', kn: 'ಸೀರೆ ಒಂದು ಉಡುಪಲ್ಲ — ಅದು ಒಂದು ತಲೆಮಾರಿನ ಕಥೆ 🧵', en: 'A saree is not just clothing — it is a generation’s story 🧵' },
  { g: 'th', ta: 'பெண்ணின் அழகு சேலையில் மட்டும் இல்லை — அவளுடைய அன்பிலும் இருக்கிறது ❤️', te: 'స్త్రీ అందం చీరలో మాత్రమే కాదు — ఆమె ప్రేమలో కూడా ఉంటుంది ❤️', kn: 'ಹೆಣ್ಣಿನ ಅಂದ ಸೀರೆಯಲ್ಲಿ ಮಾತ್ರವಲ್ಲ — ಅವಳ ಪ್ರೀತಿಯಲ್ಲೂ ಇರುತ್ತದೆ ❤️', en: 'A woman’s beauty lies not only in her saree — but in her love ❤️' },
  { g: 'th', ta: 'நல்ல நட்பு நல்ல சேலை மாதிரி — எவ்வளவு காலமும் ஒட்டிக்கிடக்கும்!', te: 'మంచి స్నేహం మంచి చీర లాగా — ఎంత కాలమైనా ఒదిగి ఉంటుంది!', kn: 'ಒಳ್ಳೆಯ ಸ್ನೇಹ ಒಳ್ಳೆಯ ಸೀರೆಯಂತೆ — ಎಷ್ಟು ಕಾಲವಾದರೂ ಅಂಟಿಕೊಂಡಿರುತ್ತದೆ!', en: 'True friendship is like a good saree — it stays close forever!' },
  { g: 'th', ta: 'வாழ்க்கை சேலை மாதிரிதான் — எப்படி உடுத்துகிறோம்ன்னது தான் முக்கியம்!', te: 'జీవితం చీర లాగా ఉంటుంది — ఎలా ధరిస్తామో అదే ముఖ్యం!', kn: 'ಬದುಕು ಸೀರೆಯಂತೆ — ಹೇಗೆ ಧರಿಸುತ್ತೇವೆ ಎಂಬುದೇ ಮುಖ್ಯ!', en: 'Life is like a saree — how you drape it is what matters!' },
  { g: 'th', ta: 'தைரியம் என்பது புது சேலை மாதிரி — உடுத்தினா தான் தெரியும் அதோட அழகு!', te: 'ధైర్యం కొత్త చీర లాగా — ధరిస్తేనే దాని అందం తెలుస్తుంది!', kn: 'ಧೈರ್ಯ ಹೊಸ ಸೀರೆಯಂತೆ — ಧರಿಸಿದರೆ ಮಾತ್ರ ಅದರ ಅಂದ ಗೊತ್ತಾಗುತ್ತದೆ!', en: 'Confidence is like a new saree — only when you wear it does its beauty show!' },
  { g: 'th', ta: 'மனசு நிறைந்தவங்களுக்கு எந்த சேலையும் கம்பெர்ட்டபுள் ❤️', te: 'మనసు నిండిన వాళ్ళకు ఏ చీర అయినా కంఫర్టబుల్ ❤️', kn: 'ಮನಸ್ಸು ತುಂಬಿದವರಿಗೆ ಯಾವ ಸೀರೆಯೇ ಆದರೂ ಕಾಮ್ಫರ್ಟಬಲ್ ❤️', en: 'For a contented heart, any saree is comfortable ❤️' },
  { g: 'th', ta: 'நேரம் காலம் மாறும் — ஆனா பாரம்பரிய அழகு மாறாது 🪡', te: 'కాలం మారుతుంది — కానీ సంప్రదాయ అందం మారదు 🪡', kn: 'ಕಾಲ ಬದಲಾಗುತ್ತದೆ — ಆದರೆ ಪರಂಪರೆಯ ಅಂದ ಬದಲಾಗುವುದಿಲ್ಲ 🪡', en: 'Time and seasons change — but classic beauty never fades 🪡' },
  { g: 'th', ta: 'சிரிச்சு பேசுனா எல்லா சேலையும் ஒத்துப்போகும் 😄', te: 'నవ్వుతూ మాట్లాడితే అన్ని చీరలు ఒదిగిపోతాయి 😄', kn: 'ನಗುತ್ತಾ ಮಾತನಾಡಿದರೆ ಎಲ್ಲಾ ಸೀರೆಯೂ ಒಪ್ಪುತ್ತದೆ 😄', en: 'Speak with a smile, and every saree suits you 😄' },
  { g: 'th', ta: 'தன்னம்பிக்கையோட இருந்தா எந்த நிறமும் உங்களுக்கு அழகா இருக்கும்!', te: 'ఆత్మవిశ్వాసంతో ఉంటే ఏ రంగు అయినా మీకు అందంగా ఉంటుంది!', kn: 'ಆತ್ಮವಿಶ್ವಾಸದಿಂದ ಇದ್ದರೆ ಯಾವ ಬಣ್ಣವೇ ಆದರೂ ನಿಮಗೆ ಅಂದವಾಗಿರುತ್ತದೆ!', en: 'With self-confidence, every colour looks beautiful on you!' },
  { g: 'th', ta: 'எளிமையான வாழ்க்கைதான் அழகான வாழ்க்கை — எளிமையான சேலையும் அப்படியே!', te: 'సరళమైన జీవితమే అందమైన జీవితం — సరళమైన చీర కూడా అలాగే!', kn: 'ಸರಳವಾದ ಬದುಕೇ ಅಂದವಾದ ಬದುಕು — ಸರಳವಾದ ಸೀರೆಯೂ ಹಾಗೆಯೇ!', en: 'A simple life is a beautiful life — and so is a simple saree!' },
  { g: 'th', ta: 'அம்மா சொன்ன வார்த்தைகள் அம்மா கட்டின சேலை மாதிரி — எப்போதும் நெஞ்சோட ஒட்டிக்கிடக்கும்', te: 'అమ్మ చెప్పిన మాటలు అమ్మ కట్టిన చీర లాగా — ఎప్పుడూ గుండెలో ఒదిగి ఉంటాయి', kn: 'ಅಮ್ಮ ಹೇಳಿದ ಮಾತುಗಳು ಅಮ್ಮ ಕಟ್ಟಿದ ಸೀರೆಯಂತೆ — ಎಂದಿಗೂ ಎದೆಯಲ್ಲಿ ಅಂಟಿಕೊಂಡಿರುತ್ತವೆ', en: 'A mother’s words, like the saree she draped — stay close to the heart forever' },
  { g: 'th', ta: 'வீண் பெருமை தேவையில்லை — நல்ல பண்புதான் உண்மையான அழகு', te: 'గర్వం అక్కర్లేదు — మంచి నడతనే నిజమైన అందం', kn: 'ಹೆಮ್ಮೆ ಬೇಡ — ಒಳ್ಳೆಯ ನಡತೆಯೇ ನಿಜವಾದ ಅಂದ', en: 'No need for empty pride — good character is the true beauty' },
  { g: 'th', ta: 'பொறுமை இருந்தா பாதி வெற்றி கிடைச்சிடும் — மீதி முயற்சி!', te: 'ఓర్పు ఉంటే సగం విజయం వస్తుంది — మిగతా ప్రయత్నం!', kn: 'ತಾಳ್ಮೆ ಇದ್ದರೆ ಅರ್ಧ ಜಯ ಸಿಗುತ್ತದೆ — ಉಳಿದದು ಪ್ರಯತ್ನ!', en: 'With patience, half the victory is won — the rest is effort!' },
  { g: 'th', ta: 'கொடுத்தா தான் கிடைக்கும் — அன்பு கொடுத்தா அன்பு கிடைக்கும் ❤️', te: 'ఇస్తేనే దక్కుతుంది — ప్రేమ ఇస్తే ప్రేమ దక్కుతుంది ❤️', kn: 'ಕೊಟ್ಟರೆ ಮಾತ್ರ ಸಿಗುತ್ತದೆ — ಪ್ರೀತಿ ಕೊಟ್ಟರೆ ಪ್ರೀತಿ ಸಿಗುತ್ತದೆ ❤️', en: 'Only what you give comes back — give love, receive love ❤️' },
  { g: 'th', ta: 'எந்த கஷ்டமும் எப்போதும் இருக்காது — நல்ல நேரம் வரும் 🌈', te: 'ఏ కష్టమూ శాశ్వతం కాదు — మంచి కాలం వస్తుంది 🌈', kn: 'ಯಾವ ಕಷ್ಟವೂ ಶಾಶ್ವತವಲ್ಲ — ಒಳ್ಳೆಯ ಕಾಲ ಬರುತ್ತದೆ 🌈', en: 'No hardship lasts forever — good times will come 🌈' },
  { g: 'th', ta: 'நம்ம பிள்ளைகளுக்கு நாம விட்டுப்போற பாரம்பரியம் தான் நம்ம அடையாளம் 🧵', te: 'పిల్లలకు మనం వదిలే సంప్రదాయమే మన గుర్తింపు 🧵', kn: 'ಮಕ್ಕಳಿಗೆ ನಾವು ಬಿಟ್ಟುಹೋಗುವ ಪರಂಪರೆಯೇ ನಮ್ಮ ಗುರುತು 🧵', en: 'The heritage we leave our children is our true identity 🧵' },
  { g: 'th', ta: 'உண்மையான அழகு முகத்துல இல்லை — மனசுல இருக்கு 💛', te: 'నిజమైన అందం ముఖంలో లేదు — మనసులో ఉంటుంది 💛', kn: 'ನಿಜವಾದ ಅಂದ ಮುಖದಲ್ಲಿಲ್ಲ — ಮನಸ್ಸಿನಲ್ಲಿರುತ್ತದೆ 💛', en: 'True beauty is not on the face — it lives in the heart 💛' },
  { g: 'th', ta: 'கற்றுக்கொள்ளுறதுல வயசு இல்லை — அது சேலை மாதிரி, எப்போ வேணும்னாலும் அழகா இருக்கும்!', te: 'నేర్చుకోవడంలో వయసు లేదు — అది చీర లాగా, ఎప్పుడైనా అందంగా ఉంటుంది!', kn: 'ಕಲಿಯುವುದರಲ್ಲಿ ವಯಸ್ಸಿಲ್ಲ — ಅದು ಸೀರೆಯಂತೆ, ಯಾವಾಗಲೂ ಅಂದವಾಗಿರುತ್ತದೆ!', en: 'Learning has no age — like a saree, it looks beautiful whenever you wear it!' },
  { g: 'th', ta: 'சுற்றம் என்பது சொகம் — அவங்க கொடுக்குற பாசம் வேற எதுவும் இல்ல ❤️', te: 'బంధువులు అనేది సుఖం — వాళ్ళ ప్రేమకు మించినది లేదు ❤️', kn: 'ಸಂಬಂಧಿಕರೆಂಬುದು ಸುಖ — ಅವರ ಪ್ರೀತಿಗೆ ಬೇರೇನೂ ಸಮನಿಲ್ಲ ❤️', en: 'Family is pure joy — their love is beyond compare ❤️' },
  { g: 'th', ta: 'விதி என்ன செய்யும் — முயற்சி நம்ம கைல தான் இருக்கு!', te: 'విధి ఏం చేస్తుందో — ప్రయత్నం మన చేతుల్లోనే ఉంది!', kn: 'ವಿಧಿ ಏನು ಮಾಡುತ್ತದೋ — ಪ್ರಯತ್ನ ನಮ್ಮ ಕೈಯಲ್ಲೇ ಇದೆ!', en: 'What can fate do — effort is in our hands!' },
  { g: 'th', ta: 'சேலையோட அழகு அதோட விலையில இல்லை — அதை கட்டுற மனசுல இருக்கு', te: 'చీర అందం దాని ధరలో లేదు — దాన్ని ధరించే మనసులో ఉంటుంది', kn: 'ಸೀರೆಯ ಅಂದ ಅದರ ಬೆಲೆಯಲ್ಲಿಲ್ಲ — ಅದನ್ನು ಧರಿಸುವ ಮನಸ್ಸಿನಲ್ಲಿದೆ', en: 'A saree’s beauty is not in its price — it is in the heart that drapes it' },
  { g: 'th', ta: 'தவறு செய்யாதவங்க கிடையாது — திருத்திக்கிறவங்க தான் உண்மையான வெற்றியாளர்', te: 'తప్పు చేయని వాళ్ళు లేరు — సరిచేసుకునేవాళ్ళే నిజమైన విజేతలు', kn: 'ತಪ್ಪು ಮಾಡದವರಿಲ್ಲ — ತಿದ್ದಿಕೊಳ್ಳುವವರೇ ನಿಜವಾದ ವಿಜೇತರು', en: 'No one is without mistakes — those who correct themselves are the true winners' },
  { g: 'th', ta: 'புது சேலை கட்டினா மனசுக்கு தெரியும் — சின்ன சந்தோஷம்தான் வாழ்க்கை!', te: 'కొత్త చీర ధరిస్తే మనసుకు తెలుస్తుంది — చిన్న సంతోషమే జీవితం!', kn: 'ಹೊಸ ಸೀರೆ ಧರಿಸಿದರೆ ಮನಸಿಗೆ ಗೊತ್ತಾಗುತ್ತದೆ — ಸಣ್ಣ ಸಂತೋಷವೇ ಬದುಕು!', en: 'Wear a new saree and your heart knows — little joys ARE life!' },
  { g: 'th', ta: 'யாரும் முழு நிலவு இல்லை — குறை இருந்தா தான் அழகு 🌕', te: 'ఎవరూ పూర్ణ చంద్రుడు కారు — లోపం ఉంటేనే అందం 🌕', kn: 'ಯಾರೂ ಪೂರ್ಣ ಚಂದ್ರನಲ್ಲ — ಕೊರತೆ ಇದ್ದರೆ ಮಾತ್ರ ಅಂದ 🌕', en: 'No one is a full moon — beauty lies in imperfection 🌕' },
  { g: 'th', ta: 'அடுத்தவங்க நல்லா இருக்குறத பார்த்து பொறாமை படாதீங்க — நீங்களும் நல்லா இருங்க!', te: 'ఇతరులు బాగున్నారని అసూయ పడకండి — మీరు కూడా బాగుండండి!', kn: 'ಇತರರು ಚೆನ್ನಾಗಿದ್ದಾರೆ ಎಂದು ಅಸೂಯೆ ಪಡಬೇಡಿ — ನೀವೂ ಚೆನ್ನಾಗಿರಿ!', en: 'Don’t envy others’ good fortune — you flourish too!' },
  { g: 'th', ta: 'மௌனம் என்பது பலவீனம் இல்லை — அது புத்திசாலித்தனம் 🤫', te: 'మౌనం బలహీనత కాదు — అది తెలివైన తనం 🤫', kn: 'ಮೌನ ದೌರ್ಬಲ್ಯವಲ್ಲ — ಅದು ಬುದ್ಧಿಮತ್ತೆ 🤫', en: 'Silence is not weakness — it is wisdom 🤫' },
  { g: 'th', ta: 'முதல் மதிப்பு கண்ணுக்கு — ஆனா நிலைக்குற மதிப்பு மனசுக்கு!', te: 'మొదటి మెప్పు కంటికి — నిలిచే మెప్పు మనసుకు!', kn: 'ಮೊದಲ ಮೆಚ್ಚುಗೆ ಕಣ್ಣಿಗೆ — ಉಳಿಯುವ ಮೆಚ್ಚುಗೆ ಮನಸಿಗೆ!', en: 'First impressions are for the eyes — lasting worth is for the heart!' },
  { g: 'th', ta: 'ஒரு நல்ல சேலை ஒரு நல்ல நண்பன் — எப்போதும் உங்களோட இருக்கும்!', te: 'మంచి చీర మంచి స్నేహితుడిలా — ఎప్పుడూ మీతో ఉంటుంది!', kn: 'ಒಳ್ಳೆಯ ಸೀರೆ ಒಳ್ಳೆಯ ಸ್ನೇಹಿತ — ಎಂದಿಗೂ ನಿಮ್ಮೊಂದಿಗೆ ಇರುತ್ತದೆ!', en: 'A good saree is like a good friend — always with you!' },
  { g: 'th', ta: 'கஷ்டப்பட்டு சம்பாதிச்சது தான் இனிக்கும் — அது சேலையா இருந்தாலும் சரி!', te: 'కష్టపడి సంపాదించిందే తీపిగా ఉంటుంది — అది చీరైనా సరే!', kn: 'ಶ್ರಮಪಟ್ಟು ಸಂಪಾದಿಸಿದ್ದೇ ಸವಿಯಾಗಿರುತ್ತದೆ — ಅದು ಸೀರೆಯಾದರೂ ಸರಿ!', en: 'What is earned with hard work tastes sweetest — even a saree!' },
  { g: 'th', ta: 'மறந்துட்டு மன்னிக்கணும் வாழ்க்கைல — அதுதான் நிம்மதி 🕊️', te: 'మరచిపోయి క్షమించాలి జీవితంలో — అదే శాంతి 🕊️', kn: 'ಮರೆತು ಕ್ಷಮಿಸಬೇಕು ಬದುಕಿನಲ್ಲಿ — ಅದೇ ಶಾಂತಿ 🕊️', en: 'Life asks us to forget and forgive — that is peace 🕊' },
  { g: 'th', ta: 'நல்லவங்களுக்கு நல்லது நடக்கும் — கொஞ்சம் நேரம் எடுத்தாலும் ⏳', te: 'మంచివాళ్ళకు మంచిది జరుగుతుంది — కొంచెం సమయం పట్టినా ⏳', kn: 'ಒಳ್ಳೆಯವರಿಗೆ ಒಳ್ಳೆಯದು ಆಗುತ್ತದೆ — ಸ್ವಲ್ಪ ಸಮಯ ತೆಗೆದುಕೊಂಡರೂ ⏳', en: 'Good things happen to good people — even if it takes time ⏳' },
  { g: 'th', ta: 'அழகும் அறிவும் சேர்ந்தா — அது தான் பெண்மை 💪', te: 'అందమూ అనుభవమూ కలిస్తే — అదే స్త్రీత్వం 💪', kn: 'ಅಂದವೂ ಬುದ್ಧಿಯೂ ಸೇರಿದರೆ — ಅದೇ ಹೆಣ್ಣಿಮೆ 💪', en: 'When beauty and wisdom unite — that is womanhood 💪' },
  { g: 'th', ta: 'ஒவ்வொரு சேலையும் ஒரு கலை — ஒவ்வொரு பெண்ணும் ஒரு கலைஞர் 🎨', te: 'ప్రతి చీర ఒక కళ — ప్రతి స్త్రీ ఒక కళాకారిణి 🎨', kn: 'ಪ್ರತಿ ಸೀರೆ ಒಂದು ಕಲೆ — ಪ್ರತಿ ಹೆಣ್ಣೂ ಒಬ್ಬ ಕಲಾವಿದೆ 🎨', en: 'Every saree is an art — every woman is an artist 🎨' },
  { g: 'th', ta: 'முடிஞ்சத பத்திரமா வெச்சுக்கோங்க — பழையது தான் அழகு!', te: 'ఉన్నది సురక్షితంగా దాచుకోండి — పాతదే అందం!', kn: 'ಇರುವುದನ್ನು ಸುರಕ್ಷಿತವಾಗಿ ಇಟ್ಟುಕೊಳ್ಳಿ — ಹಳೆಯದೇ ಅಂದ!', en: 'Treasure what you have — the old is beautiful too!' },
  { g: 'th', ta: 'பணம் வந்து போகும் — ஆனா நல்ல பேரு நிலைக்கும் ✨', te: 'డబ్బు వస్తుంది పోతుంది — కానీ మంచి పేరు నిలుస్తుంది ✨', kn: 'ಹಣ ಬರುತ್ತದೆ ಹೋಗುತ್ತದೆ — ಆದರೆ ಒಳ್ಳೆಯ ಹೆಸರು ಉಳಿಯುತ್ತದೆ ✨', en: 'Money comes and goes — but a good name lasts ✨' },
  { g: 'th', ta: 'நல்ல மனசு பெரிய ஆபரணம் — அது எந்த சேலைக்கும் match ஆகும் 💎', te: 'మంచి మనసు పెద్ద ఆభరణం — అది ఏ చీరకైనా సరిపోతుంది 💎', kn: 'ಒಳ್ಳೆಯ ಮನಸ್ಸು ದೊಡ್ಡ ಆಭರಣ — ಅದು ಯಾವ ಸೀರೆಗೂ ಹೊಂದುತ್ತದೆ 💎', en: 'A good heart is the greatest ornament — it matches any saree 💎' },
  /* ✨ கவிதை / Poetry (30) */
  { g: 'ka', ta: 'நூலில் நெய்த கனவுகள்... சேலையில் சுமக்கும் கவிதைகள்... 🧵✨', te: 'నూలులో నేసిన కలలు... చీరలో మోసే కవితలు... 🧵✨', kn: 'ನೂಲಲ್ಲಿ ಹೆಣೆದ ಕನಸುಗಳು... ಸೀರೆಯಲ್ಲಿ ಹೊತ್ತ ಕವನಗಳು... 🧵✨', en: 'Dreams woven in thread... poems carried in sarees... 🧵✨' },
  { g: 'ka', ta: 'அம்மா கட்டின சேலையில் இருக்கு உலகின் மென்மையான அணிசல் ❤️', te: 'అమ్మ కట్టిన చీరలో ఉంది లోకపు మెత్తని ఆతిథ్యం ❤️', kn: 'ಅಮ್ಮ ಕಟ್ಟಿದ ಸೀರೆಯಲ್ಲಿದೆ ಜಗತ್ತಿನ ಮೃದುವಾದ ಆತಿಥ್ಯ ❤️', en: 'In a mother’s saree lives the world’s gentlest embrace ❤️' },
  { g: 'ka', ta: 'பட்டும் பஞ்சையும் பேசும் கவிதை... அது தான் சேலை!', te: 'పట్టును పంచెను మాట్లాడే కవిత... అదే చీర!', kn: 'ರೇಷ್ಮೆಯನ್ನು ಪಂಚೆಯನ್ನು ಮಾತನಾಡುವ ಕವನ... ಅದೇ ಸೀರೆ!', en: 'Silk and cotton speak poetry... that is a saree!' },
  { g: 'ka', ta: 'ஒரு சேலை — ஆயிரம் நினைவுகள்... ஒரு பார்வை — ஆயிரம் கவிதைகள் ✨', te: 'ఒక చీర — వెయ్యి జ్ఞాపకాలు... ఒక చూపు — వెయ్యి కవితలు ✨', kn: 'ಒಂದು ಸೀರೆ — ಸಾವಿರ ನೆನಪುಗಳು... ಒಂದು ನೋಟ — ಸಾವಿರ ಕವನಗಳು ✨', en: 'One saree — a thousand memories... one glance — a thousand poems ✨' },
  { g: 'ka', ta: 'பெண்மை என்னும் கோவிலுக்கு சேலை தான் மாலை 🌸', te: 'స్త్రీత్వమనే ఆలయానికి చీరే పూలమాల 🌸', kn: 'ಹೆಣ್ಣಿಮೆಯೆಂಬ ದೇವಾಲಯಕ್ಕೆ ಸೀರೆಯೇ ಪುಷ್ಪಹಾರ 🌸', en: 'The saree is the garland for the temple of womanhood 🌸' },
  { g: 'ka', ta: 'மஞ்சள் நிற முகில் மாதிரி... பட்டுச் சேலை மனசுக்குள்ள மெதுவா விழுந்தா மாதிரி 🌅', te: 'పసుపు రంగు మేఘం లాగా... పట్టు చీర మనసులో నెమ్మదిగా వాలినట్టు 🌅', kn: 'ಹಳದಿ ಬಣ್ಣದ ಮೋಡದಂತೆ... ರೇಷ್ಮೆ ಸೀರೆ ಮನಸಿನಲ್ಲಿ ನಿಧಾನವಾಗಿ ಉದುರಿದಂತೆ 🌅', en: 'Like a golden cloud... like silk falling softly into the heart 🌅' },
  { g: 'ka', ta: 'தையல் கலைஞரின் கைகளில் வாழும் கவிதை ஒவ்வொரு சேலையும் 🪡', te: 'కుట్టు కళాకారుడి చేతుల్లో బతికే కవిత ప్రతి చీర 🪡', kn: 'ಹೊಲಿಗೆ ಕಲಾವಿದನ ಕೈಯಲ್ಲಿ ಬದುಕುವ ಕವನ ಪ್ರತಿ ಸೀರೆ 🪡', en: 'Every saree is a poem living in a weaver’s hands 🪡' },
  { g: 'ka', ta: 'அழகு என்பது கண்ணால் பார்க்கும் காட்சி அல்ல — மனசால் உணரும் கவிதை 💛', te: 'అందం అనేది కంటితో చూసే దృశ్యం కాదు — మనసుతో అనుభవించే కవిత 💛', kn: 'ಅಂದ ಕಣ್ಣಿನಿಂದ ನೋಡುವ ದೃಶ್ಯವಲ್ಲ — ಮನಸ್ಸಿನಿಂದ ಅನುಭವಿಸುವ ಕವನ 💛', en: 'Beauty is not a sight for the eyes — it is a poem felt by the heart 💛' },
  { g: 'ka', ta: 'பல்லவி போல பளபளக்கும் ஜரி... சரணம் போல சுருண்டு விழும் தலைப்பு... 🎵', te: 'పల్లవి లాంటి మెరిసే జరి... చరణం లాంటి చుట్టుకునే అంచు... 🎵', kn: 'ಪಲ್ಲವಿಯಂತೆ ಹೊಳೆಯುವ ಜರಿ... ಚರಣೆಯಂತೆ ಸುರುಳಿ ಸುತ್ತುವ ಸೊಂடೆ... 🎵', en: 'Zari that shines like a pallavi... a pallu that falls like a refrain 🎵' },
  { g: 'ka', ta: 'காத்திருந்த கனவுகள் கரை கண்டது போல... கட்டிய சேலை களை கட்டுகிறது ✨', te: 'ఎదురుచూసిన కలలు ఒడిరినట్టే... ధరించిన చీర కళను కట్టుతుంది ✨', kn: 'ಕಾಯುತ್ತಿದ್ದ ಕನಸುಗಳು ದಡ ಸೇರಿದಂತೆ... ಧರಿಸಿದ ಸೀರೆ ಕಳೆ ಕಟ್ಟುತ್ತದೆ ✨', en: 'Like long-awaited dreams coming true... draping a saree lifts the spirit ✨' },
  { g: 'ka', ta: 'சேலையின் சுருக்கு போல... வாழ்க்கையின் மடிப்புகளும் அழகா இருக்கணும்!', te: 'చీర చుక్కీ లాగా... జీవిత మడుతలు కూడా అందంగా ఉండాలి!', kn: 'ಸೀರೆಯ ಸುಕ್ಕಿನಂತೆ... ಬದುಕಿನ ಮಡಚುಗಳೂ ಅಂದವಾಗಿರಬೇಕು!', en: 'Like a saree’s pleats... may life’s folds be beautiful too!' },
  { g: 'ka', ta: 'அப்பா வாங்கித் தந்த முதல் சேலை — அது ஒரு கவிதையின் முதல் வரி ❤️', te: 'నాన్న కొని ఇచ్చిన మొదటి చీర — అది కవితకు మొదటి పంక్తి ❤️', kn: 'ಅಪ್ಪ ತಂದುಕೊಟ್ಟ ಮೊದಲ ಸೀರೆ — ಅದು ಕವನದ ಮೊದಲ ಸಾಲು ❤️', en: 'The first saree gift from father — like the first line of a poem ❤️' },
  { g: 'ka', ta: 'மழைத் துளியில் மணக்கும் மண்... பட்டுச் சேலையில் மணக்கும் பெண்மை 🌧️', te: 'వర్షపు బొట్టులో వాసన భూమి... పట్టు చీరలో వాసన స్త్రీత్వం 🌧️', kn: 'ಮಳೆಯ ಹನಿಯಲ್ಲಿ ಅಡಕ್ಕುವ ಮಣ್ಣು... ರೇಷ್ಮೆ ಸೀರೆಯಲ್ಲಿ ಅಡಕ್ಕುವ ಹೆಣ್ಣಿಮೆ 🌧️', en: 'The earth smells in raindrops... womanhood smells in silk 🌧️' },
  { g: 'ka', ta: 'சிவந்த கன்னம் சேலை சிவப்போட சண்டை போடும் — யார் அழகுன்னு 😊', te: 'ఎర్రని బుగ్గ చీర ఎరుపుతో పోటీ పడుతుంది — ఎవరు అందం అని 😊', kn: 'ಕೆಂಪಾದ ಕೆನ್ನೆ ಸೀರೆ ಕೆಂಪಿನೊಂದಿಗೆ ಸ್ಪರ್ಧೆ ಮಾಡುತ್ತದೆ — ಯಾರು ಅಂದ ಎಂದು 😊', en: 'Blushing cheeks compete with the red saree — who is more beautiful? 😊' },
  { g: 'ka', ta: 'நிலவை நெசவு செஞ்சா எப்படி இருக்கும்? அது தான் வெள்ளைச் சேலை 🌕', te: 'నెలను నేస్తే ఎలా ఉంటుంది? అదే తెలుపు చీర 🌕', kn: 'ಚಂದ್ರನನ್ನು ಹೆಣೆದರೆ ಹೇಗಿರುತ್ತದೆ? ಅದೇ ಬಿಳಿ ಸೀರೆ 🌕', en: 'What if the moon were woven? That would be a white saree 🌕' },
  { g: 'ka', ta: 'சேலை கட்டிய பெண் நடந்தால் — கவிதை நடனமாடுது மாதிரி 💃', te: 'చీర కట్టిన స్త్రీ నడిస్తే — కవిత నాట్యం చేస్తున్నట్టు 💃', kn: 'ಸೀರೆ ಧರಿಸಿದ ಹೆಣ್ಣು ನಡೆದರೆ — ಕವನ ನರ್ತಿಸುತ್ತಿದ್ದಂತೆ 💃', en: 'When a woman in a saree walks — poetry itself dances 💃' },
  { g: 'ka', ta: 'காஞ்சிபுரத்து கோவில் கோபுரம் சேலையா மாறும் அற்புதம் 🛕', te: 'కంచి గుడి గోపురం చీరగా మారే అద్భుతం 🛕', kn: 'ಕಾಂಚಿ ದೇವಸ್ಥಾನದ ಗೋಪುರ ಸೀರೆಯಾಗಿ ಮಾರ್ಪಡುವ ಅದ್ಭುತ 🛕', en: 'The wonder of Kanchipuram temple towers turning into sarees 🛕' },
  { g: 'ka', ta: 'ஒவ்வொரு வண்ணமும் ஒரு உணர்வு — ஒவ்வொரு சேலையும் ஒரு கதை 🎨', te: 'ప్రతి రంగూ ఒక భావన — ప్రతి చీర ఒక కథ 🎨', kn: 'ಪ್ರತಿ ಬಣ್ಣವೂ ಒಂದು ಭಾವನೆ — ಪ್ರತಿ ಸೀರೆಯೂ ಒಂದು ಕಥೆ 🎨', en: 'Every colour is a feeling — every saree is a story 🎨' },
  { g: 'ka', ta: 'அணிந்தால் அரங்கேறும் கவிதை — அது தான் பட்டுச் சேலை 🎭', te: 'ధరిస్తే రంగస్థలం ఎక్కే కవిత — అదే పట్టు చీర 🎭', kn: 'ಧರಿಸಿದರೆ ರಂಗಕ್ಕೇರುವ ಕವನ — ಅದೇ ರೇಷ್ಮೆ ಸೀರೆ 🎭', en: 'Wear it, and poetry takes the stage — that is the silk saree 🎭' },
  { g: 'ka', ta: 'பாட்டிக் காட்டிய பழைய சேலையில் இன்னும் பாட்டியோட வாசனை இருக்கு 🌹', te: 'అమ్మమ్మ చూపిన పాత చీరలో ఇంకా అమ్మమ్మ సువాసన ఉంది 🌹', kn: 'ಅಜ್ಜಿ ತೋರಿಸಿದ ಹಳೆಯ ಸೀರೆಯಲ್ಲಿ ಇನ್ನೂ ಅಜ್ಜಿಯ ಸುಗಂಧ ಇದೆ 🌹', en: 'Grandma’s old saree still carries her fragrance 🌹' },
  { g: 'ka', ta: 'அம்மாவோட சேலை பாத்ரோம் எடுத்தா கண்ணுல கண்ணீர் — அது அன்புன்னு தெரியும் 😢❤️', te: 'అమ్మ చీర పెట్టె తీస్తే కళ్ళలో నీళ్ళు — అది ప్రేమ అని తెలుసు 😢❤️', kn: 'ಅಮ್ಮನ ಸೀರೆಯ ಪೆಟ್ಟಿಗೆ ತೆರೆದರೆ ಕಣ್ಣಲ್ಲಿ ನೀರು — ಅದು ಪ್ರೀತಿ ಎಂದು ಗೊತ್ತು 😢❤️', en: 'Opening mother’s saree box brings tears — that is love 😢❤️' },
  { g: 'ka', ta: 'மனசுக்கு இறங்குற சேலை தான் உண்மையான அழகு — விலை பெருசா இருக்கணும்ன்னு இல்ல 💛', te: 'మనసుకు నచ్చిన చీరే నిజమైన అందం — ధర పెద్దది అవ్వాలని లేదు 💛', kn: 'ಮನಸಿಗೆ ಇಳಿಯುವ ಸೀರೆಯೇ ನಿಜವಾದ ಅಂದ — ಬೆಲೆ ದೊಡ್ಡದಾಗಿರಬೇಕು ಎಂಬುದಿಲ್ಲ 💛', en: 'The saree that touches the heart is true beauty — the price does not matter 💛' },
  { g: 'ka', ta: 'திருமணத்துல மணப்பெண் அணியறது சேலைய இல்லை — கனவுகளை 💭✨', te: 'పెళ్ళిలో పెళ్ళికూతురు ధరించేది చీర కాదు — కలలను 💭✨', kn: 'ಮದುವೆಯಲ್ಲಿ ವಧು ಧರಿಸುವುದು ಸೀರೆಯಲ್ಲ — ಕನಸುಗಳನ್ನು 💭✨', en: 'At a wedding, the bride drapes not a saree — but her dreams 💭✨' },
  { g: 'ka', ta: 'சேலையோட தலைப்பு மடிச்சா மறையுது — ஆனா நினைவுகள் மடியாது 🌹', te: 'చీర అంచు మడిచితే దాగిపోతుంది — కానీ జ్ఞాపకాలు మడువుతాయి 🌹', kn: 'ಸೀರೆಯ ಸೊಂಟೆ ಮಡಚಿದರೆ ಅಡಗುತ್ತದೆ — ಆದರೆ ನೆನಪುಗಳು ಮಡಕುವುದಿಲ್ಲ 🌹', en: 'Fold the saree’s pallu and it hides — but memories never fade 🌹' },
  { g: 'ka', ta: 'வண்ணங்கள் பேசும் மொழி எல்லோருக்கும் புரியாது — சேலை புரிஞ்சவங்களுக்கு மட்டும் தான் 🎨', te: 'రంగులు మాట్లాడే భాష అందరికీ అర్థం కాదు — చీర అర్థమైన వాళ్ళకే 🎨', kn: 'ಬಣ್ಣಗಳು ಮಾತನಾಡುವ ಭಾಷೆ ಎಲ್ಲರಿಗೂ ಅರ್ಥವಾಗುವುದಿಲ್ಲ — ಸೀರೆ ಅರ್ಥಮಾಡಿಕೊಂಡವರಿಗೆ ಮಾತ್ರ 🎨', en: 'The language of colours is not understood by all — only by those who understand sarees 🎨' },
  { g: 'ka', ta: 'அலமாரியில ஒவ்வொரு சேலையும் ஒரு அத்தியாயம் — சில சந்தோஷம், சில நினைவு 📖', te: 'అల్మారాలో ప్రతి చీర ఒక అధ్యాయం — కొన్ని సంతోషం, కొన్ని జ్ఞాపకం 📖', kn: 'ಅಲಮಾರಿಯಲ್ಲಿ ಪ್ರತಿ ಸೀರೆಯೂ ಒಂದು ಅಧ್ಯಾಯ — ಕೆಲವು ಸಂತೋಷ, ಕೆಲವು ನೆನಪು 📖', en: 'Every saree in the wardrobe is a chapter — some joy, some memory 📖' },
  { g: 'ka', ta: 'காலைல கட்டுற சேலை மாலையா பழகிடும் — அப்போ தான் அது உங்களோடாகும் ✨', te: 'ఉదయం ధరించిన చీర సాయంత్రానికి అలవాస్తు అవుతుంది — అప్పుడే అది మీదై అవుతుంది ✨', kn: 'ಬೆಳಿಗ್ಗೆ ಧರಿಸಿದ ಸೀರೆ ಸಂಜೆಗೆ ಒಗ್ಗುತ್ತದೆ — ಆಗ ಮಾತ್ರ ಅದು ನಿಮ್ಮದಾಗುತ್ತದೆ ✨', en: 'A saree worn in the morning fits by evening — that is when it becomes yours ✨' },
  { g: 'ka', ta: 'உலகம் மாறினாலும் — பட்டுச் சேலையோட மோகனம் மாறாது 🌍', te: 'లోకం మారినా — పట్టు చీర మోహనం మారదు 🌍', kn: 'ಜಗತ್ತು ಬದಲಾದರೂ — ರೇಷ್ಮೆ ಸೀರೆಯ ಮೋಹನ ಬದಲಾಗುವುದಿಲ್ಲ 🌍', en: 'Though the world changes — the charm of silk remains 🌍' },
  { g: 'ka', ta: 'நாளை ஒரு புது சேலை... நாளை ஒரு புது கவிதை... 🌅✨', te: 'రేపు ఒక కొత్త చీర... రేపు ఒక కొత్త కవిత... 🌅✨', kn: 'ನಾಳೆ ಒಂದು ಹೊಸ ಸೀರೆ... ನಾಳೆ ಒಂದು ಹೊಸ ಕವನ... 🌅✨', en: 'Tomorrow, a new saree... tomorrow, a new poem... 🌅✨' },
  { g: 'ka', ta: 'சேலை என்பது துணி இல்லை — ஒரு பெண்ணோட கதையோட அடுத்த பக்கம் 📖', te: 'చీర అంటే గుడ్డ కాదు — ఒక స్త్రీ కథలో తర్వాతి పేజీ 📖', kn: 'ಸೀರೆ ಎಂದರೆ ಬಟ್ಟೆಯಲ್ಲ — ಒಬ್ಬ ಹೆಣ್ಣಿನ ಕಥೆಯ ಮುಂದಿನ ಪುಟ 📖', en: 'A saree is not cloth — it is the next page of a woman’s story 📖' },
];
/* 💬 MORE quotes — Good Afternoon (மதிய வணக்கம்) + Good Evening (மாலை வணக்கம்)
   + extra kavithai / GM / GN. Same 3-language format (ta/te/kn). */
REEL_QUOTES.push(
  /* ☀️ Good Afternoon (10) */
  { g: 'ga', ta: 'மதிய வணக்கம்! 🌞 மதிய வெயிலிலும் உங்கள் மனசு குளிரா இருக்கட்டும்!', te: 'మధ్యాహ్న వందనాలు! 🌞 మధ్యాహ్న ఎండలో కూడా మీ మనసు చల్లగా ఉండాలి!', kn: 'ಮಧ್ಯಾಹ್ನದ ವಂದನೆ! 🌞 ಮಧ್ಯಾಹ್ನದ ಬಿಸಿಲಲ್ಲೂ ನಿಮ್ಮ ಮನಸ್ಸು ತಂಪಾಗಿರಲಿ!', en: 'Good afternoon! 🌞 Even in the noon heat, may your heart stay cool!' },
  { g: 'ga', ta: 'இனிய மதிய நேரம்! சுவையான மதிய உணவும், ஓரமான ஓய்வும் 🍽️', te: 'ఇంపైన మధ్యాహ్నం! రుచికరమైన భోజనం, పక్కన విశ్రాంతి 🍽️', kn: 'ಇಂಪಾದ ಮಧ್ಯಾಹ್ನ! ರುಚಿಕರವಾದ ಊಟ, ಪಕ್ಕದಲ್ಲಿ ವಿಶ್ರಾಂತಿ 🍽️', en: 'Sweet midday! A tasty lunch and a well-earned rest 🍽️' },
  { g: 'ga', ta: 'மதிய வணக்கம்! அரை நாள் வெற்றி — மீதி அரை நாளும் சிறப்பா இருக்கட்டும் ✨', te: 'మధ్యాహ్న వందనాలు! సగం రోజు విజయం — మిగతా సగం కూడా బాగుండాలి ✨', kn: 'ಮಧ್ಯಾಹ್ನದ ವಂದನೆ! ಅರ್ಧ ದಿನ ಜಯ — ಉಳಿದರ್ಧ ದಿನವೂ ಚೆನ್ನಾಗಿರಲಿ ✨', en: 'Good afternoon! Half the day is a victory — may the rest be special too ✨' },
  { g: 'ga', ta: 'வெயில் தணியும் நேரம் — மனசும் தணியட்டும்! மதிய வணக்கம் ☀️', te: 'ఎండ తగ్గే సమయం — మనసు కూడా తగ్గాలి! మధ్யాహ్న వందనాలు ☀️', kn: 'ಬಿಸಿಲು ಕಡಿಮೆಯಾಗುವ ಸಮಯ — ಮನಸ್ಸೂ ತಣಿಯಲಿ! ಮಧ್ಯಾಹ್ನದ ವಂದನೆ ☀️', en: 'As the heat settles — may your mind settle too! Good afternoon ☀️' },
  { g: 'ga', ta: 'மதிய வணக்கம்! காலை கனவுகள் நனவாகிக் கொண்டிருக்கட்டும் 💫', te: 'మధ్యాహ్న వందనాలు! ఉదయపు కలలు నిజమవుతూ ఉండాలి 💫', kn: 'ಮಧ್ಯಾಹ್ನದ ವಂದನೆ! ಬೆಳಿಗ್ಗಿನ ಕನಸುಗಳು ನನಸಾಗುತ್ತಿರಲಿ 💫', en: 'Good afternoon! May the morning’s dreams keep coming true 💫' },
  { g: 'ga', ta: 'சூரியன் உச்சியில் — உங்கள் மனசும் உச்சியில்! மதிய வணக்கம் 🌞', te: 'సూర్యుడు శిఖరంలో — మీ మనసు కూడా శిఖరంలో! మధ్యాహ్న వందనాలు 🌞', kn: 'ಸೂರ್ಯ ಶಿಖರದಲ್ಲಿ — ನಿಮ್ಮ ಮನಸ್ಸೂ ಶಿಖರದಲ್ಲಿ! ಮಧ್ಯಾಹ್ನದ ವಂದನೆ 🌞', en: 'The sun is at its peak — and so is your spirit! Good afternoon 🌞' },
  { g: 'ga', ta: 'மதிய வணக்கம்! ஒரு கப் காபி + அழகான சேலை = மனசுக்கு சந்தோஷம் ☕🥻', te: 'మధ్యాహ్న వందనాలు! ఒక కప్పు కాఫీ + అందమైన చీర = మనసుకు సంతోషం ☕🥻', kn: 'ಮಧ್ಯಾಹ್ನದ ವಂದನೆ! ಒಂದು ಕಪ್ ಕಾಫಿ + ಅಂದವಾದ ಸೀರೆ = ಮನಸಿಗೆ ಸಂತೋಷ ☕🥻', en: 'Good afternoon! A cup of coffee + a lovely saree = a happy heart ☕🦻' },
  { g: 'ga', ta: 'மதிய வேளை வணக்கம்! வேலையில் சோர்வு இருந்தாலும் முகத்தில் புன்னகை 😊', te: 'మధ్యాహ్న వందనాలు! పనిలో అలసట ఉన్నా ముఖంలో చిరునవ్వు 😊', kn: 'ಮಧ್ಯಾಹ್ನದ ವಂದನೆ! ಕೆಲಸದಲ್ಲಿ ಆಯಾಸ ಇದ್ದರೂ ಮುಖದಲ್ಲಿ ನಗು 😊', en: 'Good afternoon! Tired from work, but keep the smile on 😊' },
  { g: 'ga', ta: 'மதிய வணக்கம்! இன்றைய அரை நாள் கணக்கு — நல்லது தான்! ✅', te: 'మధ్యాహ్న వందనాలు! ఈరోజు సగం లెక్క — బాగుంది! ✅', kn: 'ಮಧ್ಯಾಹ್ನದ ವಂದನೆ! ಇಂದಿನ ಅರ್ಧ ದಿನ ಲೆಕ್ಕ — ಒಳ್ಳೆಯದು! ✅', en: 'Good afternoon! The first half’s report — all good! ✅' },
  { g: 'ga', ta: 'மதிய வணக்கம்! சேலை மாதிரி நிதானமா, அழகா இருங்கள்!', te: 'మధ్యాహ్న వందనాలు! చీర లాగా నిదానంగా, అందంగా ఉండండి!', kn: 'ಮಧ್ಯಾಹ್ನದ ವಂದನೆ! ಸೀರೆಯಂತೆ ನಿಧಾನವಾಗಿ, ಅಂದವಾಗಿ ಇರಿ!', en: 'Good afternoon! Be graceful and unhurried, like a saree!' },
  /* 🌆 Good Evening (10) */
  { g: 'ge', ta: 'மாலை வணக்கம்! 🌆 மாலை வானம் மாதிரி உங்கள் நாளும் வர்ணமயமா இருக்கட்டும்!', te: 'సాయంత్రం వందనాలు! 🌆 సాయంత్రం ఆకాశం లాగా మీ రోజు కూడా రంగులతో ఉండాలి!', kn: 'ಸಂಜೆಯ ವಂದನೆ! 🌆 ಸಂಜೆಯ ಆಕಾಶದಂತೆ ನಿಮ್ಮ ದಿನವೂ ಬಣ್ಣಮಯವಾಗಿರಲಿ!', en: 'Good evening! 🌆 May your day be as colourful as the evening sky!' },
  { g: 'ge', ta: 'இனிய மாலை வணக்கம்! சூரியன் மறையட்டும் — உங்கள் புன்னகை மட்டும் மறையாது 😊', te: 'ఇంపైన సాయంత్రం! సూర్యుడు దాగితే పర్వాలేదు — మీ చిరునవ్వు మాత్రం దాగదు 😊', kn: 'ಇಂಪಾದ ಸಂಜೆ! ಸೂರ್ಯ ಮರೆಯಲಿ — ನಿಮ್ಮ ನಗು ಮಾತ್ರ ಮರೆಯದು 😊', en: 'Sweet evening! The sun may set — but your smile never does 😊' },
  { g: 'ge', ta: 'மாலை வணக்கம்! இன்றைய களைப்பை மாலைக் காற்று அடித்துப் பறக்கட்டும் 🍃', te: 'సాయంత్రం వందనాలు! ఈరోజు అలసటను సాయంత్రం గాలి ఎగరేయాలి 🍃', kn: 'ಸಂಜೆಯ ವಂದನೆ! ಇಂದಿನ ಆಯಾಸವನ್ನು ಸಂಜೆಯ ಗಾಳಿ ಹಾರಿಸಲಿ 🍃', en: 'Good evening! Let the evening breeze carry today’s tiredness away 🍃' },
  { g: 'ge', ta: 'மாலை வணக்கம்! மாலை நேரம் = குடும்பம் + சூபு + சிரிப்பு 🏠❤️', te: 'సాయంత్రం వందనాలు! సాయంత్రం = కుటుంబం + సూప్ + నవ్వు 🏠❤️', kn: 'ಸಂಜೆಯ ವಂದನೆ! ಸಂಜೆ = ಕುಟುಂಬ + ಸೂಪ್ + ನಗು 🏠❤️', en: 'Good evening! Evening = family + soup + laughter 🏠❤️' },
  { g: 'ge', ta: 'அழகான மாலை! வானம் ஆரஞ்சு நிறம் — நீங்க எந்த நிற சேலை? 🌅', te: 'అందమైన సాయంత్రం! ఆకాశం నారింజ రంగు — మీరు ఏ రంగు చీర? 🌅', kn: 'ಅಂದವಾದ ಸಂಜೆ! ಆಕಾಶ ಕಿತ್ತಳೆ ಬಣ್ಣ — ನೀವು ಯಾವ ಬಣ್ಣದ ಸೀರೆ? 🌅', en: 'A beautiful evening! The sky is orange — which colour saree are you? 🌅' },
  { g: 'ge', ta: 'மாலை வணக்கம்! நல்ல மாலை ஒரு நல்ல இரவுக்கு அடித்தளம் 🌙', te: 'సాయంత్రం వందనాలు! మంచి సాయంత్రం మంచి రాత్రికి పునాది 🌙', kn: 'ಸಂಜೆಯ ವಂದನೆ! ಒಳ್ಳೆಯ ಸಂಜೆ ಒಳ್ಳೆಯ ರಾತ್ರಿಗೆ ಅಡಿಪಾಯ 🌙', en: 'Good evening! A good evening is the foundation of a good night 🌙' },
  { g: 'ge', ta: 'மாலை வணக்கம்! நாளை இன்னும் நல்லா இருக்கும் ✨', te: 'సాయంత్రం వందనాలు! రేపు మరింత బాగుంటుంది ✨', kn: 'ಸಂಜೆಯ ವಂದನೆ! ನಾಳೆ ಇನ್ನಷ್ಟು ಚೆನ್ನಾಗಿರುತ್ತದೆ ✨', en: 'Good evening! Tomorrow will be even better ✨' },
  { g: 'ge', ta: 'மாலை வேளை வணக்கம்! கடைசி மணி ஓட்டம் — வெற்றியா முடிக்குங்க! 💪', te: 'సాయంత్రం వందనాలు! చివరి గంట పరుగు — విజయంతో ముగించండి! 💪', kn: 'ಸಂಜೆಯ ವಂದನೆ! ಕೊನೆಯ ಗಂಟೆ ಓಟ — ವಿಜಯದೊಂದಿಗೆ ಮುಗಿಸಿ! 💪', en: 'Good evening! The final hour’s sprint — finish victorious! 💪' },
  { g: 'ge', ta: 'மாலை வணக்கம்! ஒரு நல்ல சேலை + மாலை நடை = perfect evening 🥻✨', te: 'సాయంత్రం వందనాలు! మంచి చీర + సాయంత్రం నడక = perfect evening 🥻✨', kn: 'ಸಂಜೆಯ ವಂದನೆ! ಒಳ್ಳೆಯ ಸೀರೆ + ಸಂಜೆಯ ನಡಿಗೆ = perfect evening 🥻✨', en: 'Good evening! A nice saree + an evening walk = perfect evening 🦻✨' },
  { g: 'ge', ta: 'மாலை வணக்கம்! மாலை மலர் மாதிரி வாசனையா இருங்கள் 🌆', te: 'సాయంత్రం వందనాలు! సాయంత్రం పువ్వు లాగా సువాసనగా ఉండండి 🌆', kn: 'ಸಂಜೆಯ ವಂದನೆ! ಸಂಜೆಯ ಹೂವಿನಂತೆ ಸುಗಂಧದಿಂದ ಇರಿ 🌆', en: 'Good evening! Be fragrant like the evening flower 🌆' },
  /* ✨ Extra Kavithai (10) */
  { g: 'ka', ta: 'மாலை வானம் சேலை கட்டுகிறது — சூரியன் தலைப்பாகை கட்டுகிறான் 🌅', te: 'సాయంత్రం ఆకాశం చీర కట్టుకుంటుంది — సూర్యుడు తలపాగా కట్టుకుంటాడు 🌅', kn: 'ಸಂಜೆಯ ಆಕಾಶ ಸೀರೆ ಧರಿಸುತ್ತದೆ — ಸೂರ್ಯ ಪೇಟ ಧರಿಸುತ್ತಾನೆ 🌅', en: 'The evening sky drapes a saree — the sun ties its turban 🌅' },
  { g: 'ka', ta: 'மழை வந்தா மண் மணக்கும் — சேலை வந்தா வீடு மணக்கும் 🌧️🏠', te: 'వర్షం వస్తే నేల సువాసన — చీర వస్తే ఇల్లు సువాసన 🌧️🏠', kn: 'ಮಳೆ ಬಂದರೆ ಮಣ್ಣು ಅಡಕ್ಕುತ್ತದೆ — ಸೀರೆ ಬಂದರೆ ಮನೆ ಅಡಕ್ಕುತ್ತದೆ 🌧️🏠', en: 'When rain comes, the earth smells sweet — when a saree comes, the home glows 🌧️🏠' },
  { g: 'ka', ta: 'பெண் சிரித்தால் கவிதை ஆகும் — அழுதாலும் கதை ஆகும் 💧✨', te: 'స్త్రీ నవ్వితే కవిత అవుతుంది — ఏడిస్తే కథ అవుతుంది 💧✨', kn: 'ಹೆಣ್ಣು ನಕ್ಕರೆ ಕವನವಾಗುತ್ತದೆ — ಅಳುತ್ತಿದ್ದರೂ ಕಥೆಯಾಗುತ್ತದೆ 💧✨', en: 'A woman’s laughter becomes a poem — even her tears become a story 💧✨' },
  { g: 'ka', ta: 'சேலையின் ஜரி மின்னும்போது — ராத்திரி நட்சத்திரம் பொறாமைக்கிறது ⭐', te: 'చీర జరి మెరిసినప్పుడు — రాత్రి నక్షత్రం అసూయపడుతుంది ⭐', kn: 'ಸೀರೆಯ ಜರಿ ಹೊಳೆದಾಗ — ರಾತ್ರಿ ನಕ್ಷತ್ರ ಅಸೂಯೆಪಡುತ್ತದೆ ⭐', en: 'When the saree’s zari sparkles — even the night stars feel envy ⭐' },
  { g: 'ka', ta: 'ஒரு நல்ல சேலை — அணிந்தவருக்கு தைரியம், பார்த்தவருக்கு கவிதை ✨', te: 'మంచి చీర — ధరించిన వారికి ధైర్యం, చూసిన వారికి కవిత ✨', kn: 'ಒಳ್ಳೆಯ ಸೀರೆ — ಧರಿಸಿದವರಿಗೆ ಧೈರ್ಯ, ನೋಡಿದವರಿಗೆ ಕವನ ✨', en: 'A good saree — courage to the one who wears it, poetry to those who watch ✨' },
  { g: 'ka', ta: 'வாழ்க்கை என்பது வெள்ளை சேலை — நாமளே அதற்கு வண்ணம் தீட்டணும் 🎨', te: 'జీవితం అంటే తెలుపు చీర — మనమే దానికి రంగులు వేయాలి 🎨', kn: 'ಬದುಕು ಎಂದರೆ ಬಿಳಿ ಸೀರೆ — ನಾವೇ ಅದಕ್ಕೆ ಬಣ್ಣ ಹಚ್ಚಬೇಕು 🎨', en: 'Life is a white saree — we must paint its colours ourselves 🎨' },
  { g: 'ka', ta: 'கண்ணாடி அழகை காட்டும் — சேலை ஆளுமையை காட்டும் 🪞', te: 'అద్దం అందాన్ని చూపుతుంది — చీర వ్యక్తిత్వాన్ని చూపుతుంది 🪞', kn: 'ಕನ್ನಡಿ ಅಂದವನ್ನು ತೋರಿಸುತ್ತದೆ — ಸೀರೆ ವ್ಯಕ್ತಿತ್ವವನ್ನು ತೋರಿಸುತ್ತದೆ 🪞', en: 'The mirror shows beauty — the saree shows personality 🪞' },
  { g: 'ka', ta: 'சேலை அணிந்த பெண் — நடையிலேயே ஒரு பாடல் 💃🎵', te: 'చీర ధరించిన స్త్రీ — నడకలోనే ఒక పాట 💃🎵', kn: 'ಸೀರೆ ಧರಿಸಿದ ಹೆಣ್ಣು — ನಡಿಗೆಯಲ್ಲೇ ಒಂದು ಹಾಡು 💃🎵', en: 'A woman in a saree — a song in every step 💃🎵' },
  { g: 'ka', ta: 'நல்ல சேலை எந்த கோவிலுக்கும் போகும் — அது பக்தியின் அடையாளம் 🛕', te: 'మంచి చీర ఏ గుడికి అయినా వెళ్ళే — అది భక్తి గుర్తు 🛕', kn: 'ಒಳ್ಳೆಯ ಸೀರೆ ಯಾವ ದೇವಸ್ಥಾನಕ್ಕೂ ಹೋಗುತ್ತದೆ — ಅದು ಭಕ್ತಿಯ ಗುರುತು 🛕', en: 'A good saree goes to every temple — it is a mark of devotion 🛕' },
  { g: 'ka', ta: 'மாலை நிழல் நீண்டது போல — நல்ல சேலையின் அழகும் நீளும் 🌇', te: 'సాయంత్రం నీడ పొడిగినట్టే — మంచి చీర అందం కూడా పొడిగి ఉంటుంది 🌇', kn: 'ಸಂಜೆಯ ನೆರಳು ಚಾಚಿದಂತೆ — ಒಳ್ಳೆಯ ಸೀರೆಯ ಅಂದವೂ ಚಾಚುತ್ತದೆ 🌇', en: 'As evening shadows lengthen — so does the beauty of a good saree 🌇' },
  /* ☀️ Extra GM (5) */
  { g: 'gm', ta: 'காலை வணக்கம்! புது நாள், புது வாய்ப்பு, புது வெற்றி! 🌅', te: 'శుభోదయం! కొత్త రోజు, కొత్త అవకాశం, కొత్త విజయం! 🌅', kn: 'ಶುಭೋದಯ! ಹೊಸ ದಿನ, ಹೊಸ ಅವಕಾಶ, ಹೊಸ ಜಯ! 🌅', en: 'Good morning! New day, new chance, new victory! 🌅' },
  { g: 'gm', ta: 'இனிய காலை! இன்று ஒரு புது சேலை அணிந்து புதுசா உணருங்கள் ✨', te: 'ఇంపైన ఉదయం! ఈరోజు కొత్త చీర ధరించి కొత్తగా అనుభవించండి ✨', kn: 'ಇಂಪಾದ ಬೆಳಗು! ಇಂದು ಹೊಸ ಸೀರೆ ಧರಿಸಿ ಹೊಸದಾಗಿ ಅನುಭವಿಸಿ ✨', en: 'Sweet morning! Wear a new saree today and feel brand new ✨' },
  { g: 'gm', ta: 'காலை வணக்கம்! ரோஜா மலர் மாதிரி புத்துணர்ச்சியோடு வாழுங்கள் 🌹', te: 'శుభోదయం! గులాబీ పువ్వు లాగా చైతన్యంగా జీవించండి 🌹', kn: 'ಶುಭೋದಯ! ಗುಲಾಬಿ ಹೂವಿನಂತೆ ಉತ್ಸಾಹದಿಂದ ಬಾಳಿ 🌹', en: 'Good morning! Live each day fresh like a rose 🌹' },
  { g: 'gm', ta: 'காலை வணக்கம்! இன்றைய முதல் அழகு — உங்களுடைய புன்னகை 😊', te: 'శుభోదయం! ఈరోజు మొదటి అందం — మీ చిరునవ్వు 😊', kn: 'ಶುಭೋದಯ! ಇಂದಿನ ಮೊದಲ ಅಂದ — ನಿಮ್ಮ ನಗು 😊', en: 'Good morning! Today’s first beauty — your smile 😊' },
  { g: 'gm', ta: 'சூரிய உதயம் போல பிரகாசமான நாள் வரட்டும்! காலை வணக்கம் ☀️', te: 'సూర్యోదయం లాగా ప్రకాశవంతమైన రోజు రావాలి! శుభోదయం ☀️', kn: 'ಸೂರ್ಯೋದಯದಂತೆ ಪ್ರಕಾಶಮಾನವಾದ ದಿನ ಬರಲಿ! ಶುಭೋದಯ ☀️', en: 'May your day shine bright like the sunrise! Good morning ☀️' },
  /* 🌙 Extra GN (5) */
  { g: 'gn', ta: 'இரவு வணக்கம்! இன்றைய அனைத்து நினைவுகளும் இனிமையா தூங்கட்டும் 🌙', te: 'రాత్రి వందనాలు! ఈరోజు జ్ఞాపకాలన్నీ ఇంపుగా నిద్రించాలి 🌙', kn: 'ರಾತ್ರಿ ವಂದನೆ! ಇಂದಿನ ಎಲ್ಲಾ ನೆನಪುಗಳೂ ಇಂಪಾಗಿ ನಿದ್ರಿಸಲಿ 🌙', en: 'Good night! May all of today’s memories sleep sweetly 🌙' },
  { g: 'gn', ta: 'நல்ல இரவு! நட்சத்திரங்கள் உங்கள் கனவுகளுக்கு வழிகாட்டட்டும் ✨', te: 'మంచి రాత్రి! నక్షత్రాలు మీ కలలకు దారి చూపాలి ✨', kn: 'ಒಳ್ಳೆಯ ರಾತ್ರಿ! ನಕ್ಷತ್ರಗಳು ನಿಮ್ಮ ಕನಸುಗಳಿಗೆ ದಾರಿ ತೋರಿಸಲಿ ✨', en: 'Good night! May the stars guide your dreams ✨' },
  { g: 'gn', ta: 'இரவு வணக்கம்! நாளை ஒரு புது அத்தியாயம் — நல்லதா இருக்கும் 📖', te: 'రాత్రి వందనాలు! రేపు కొత్త అధ్యాయం — మంచిదే ఉంటుంది 📖', kn: 'ರಾತ್ರಿ ವಂದನೆ! ನಾಳೆ ಹೊಸ ಅಧ್ಯಾಯ — ಒಳ್ಳೆಯದೇ ಇರುತ್ತದೆ 📖', en: 'Good night! Tomorrow is a new chapter — it will be good 📖' },
  { g: 'gn', ta: 'இனிய இரவு! தூக்கத்தில் அமைதியும், கனவில் சந்தோஷமும் 🕊️', te: 'ఇంపైన రాత్రి! నిద్రలో శాంతి, కలలో సంతోషం 🕊️', kn: 'ಇಂಪಾದ ರಾತ್ರಿ! ನಿದ್ರೆಯಲ್ಲಿ ಶಾಂತಿ, ಕನಸಿನಲ್ಲಿ ಸಂತೋಷ 🕊️', en: 'Sweet night! Peace in sleep, joy in dreams 🕊' },
  { g: 'gn', ta: 'இரவு வணக்கம்! இன்று நன்றி — நாளை வெற்றி 🌟', te: 'రాత్రి వందనాలు! ఈరోజు కృతజ్ఞత — రేపు విజయం 🌟', kn: 'ರಾತ್ರಿ ವಂದನೆ! ಇಂದು ಕೃತಜ್ಞತೆ — ನಾಳೆ ಜಯ 🌟', en: 'Good night! Today, gratitude — tomorrow, victory 🌟' }
);
...
function reelsLang(){
  try{
    ...
    for (const tg of tags){
      const p = String(tg).split('-')[0].trim();
      if (p === 'ta' || p === 'te' || p === 'kn' || p === 'en') return p;
    }
  }catch(e){}
  return 'ta';
}
...
function reelHTML(p, i){
  ...
  return '<section class="rp-reel" data-rid="' + esc(p.id) + '" data-q="' + esc(q) + '">' +
    ...
    '<div class="rp-bottom"><div class="rp-card">' +
      ...
      '</div>' +
      '<a class="btn btn-buy rpc-buy" href="product.html?id=' + encodeURIComponent(p.id) + '">🛒 SHOP NOW ₹' + price.toLocaleString('en-IN') + '</a>' +
...
let __comboSel = { pid: '', shirt: '', qty: 1 };
function comboPick(pid){
  __comboSel.pid = pid;
  __comboSel.qty = 1;
  try{ renderComboPage(); }catch(e){}
}
function comboSize(size){
  __comboSel.shirt = (__comboSel.shirt === size ? '' : size);
  try{ renderComboPage(); }catch(e){}
}
function comboQty(d){
  __comboSel.qty = Math.max(1, Math.min(10, __comboSel.qty + (d || 0)));
  try{ renderComboPage(); }catch(e){}
}
function renderComboPage(){
  const app = document.getElementById('app'); if (!app) return;
  const SHIRT_SIZES = ['S36', 'M38', 'L40', 'XL42', 'XXL44'];
  /* 🧵 ONLY combo-category products (admin: product category = "Combo Sets") */
  const combos = (typeof PRODUCTS !== 'undefined' ? PRODUCTS : []).filter(p => !p.hidden && p.cat === 'combo');
  const sel = combos.find(p => p.id === __comboSel.pid) || null;
  const hero = '<div class="cmb-hero"><span class="cmb-kick">🧵 FAMILY COMBO OFFER</span>' +
      '<h1>👨‍👩‍👧‍👦 Dhoti + Shirt &amp; Saree Combo Sets</h1>' +
      '<p>குடும்பமா ஒரே மாதிரி அழகு! Wedding, function, festival-க்கு பொருத்தமான <b>saree + dhoti + shirt</b> combo sets.<br>Combo set தேர்ந்தெடுங்கள் — <b>size (S36–XXL44) + quantity</b> சொல்லி WhatsApp-ல் order பண்ணுங்கள்! 💬</p>' +
      '<div class="cmb-courier">🚚 Combo courier: <b>TN ₹60</b> • <b>AP/KA ₹80</b> • <b>Others ₹100</b> &nbsp;•&nbsp; 💵 COD Available</div>' +
    '</div>';
  /* 😊 no combo products yet — friendly WhatsApp ask (never a dead page) */
  if (!combos.length){
    app.innerHTML = '<div class="wrap page">' + hero +
      '<div class="empty" style="margin-top:16px"><div class="e-ic">🧵</div><b>Combo sets விரைவில் வரும்!</b>' +
        'Dhoti + Shirt &amp; Saree combo sets-ஐ பற்றி WhatsApp-ல் கேளுங்கள் — உங்களுக்கு ஏற்ற combo-ஐ உடனே suggest பண்றோம்! 😊' +
        '<a class="btn btn-wa" style="max-width:340px;margin:12px auto 0" href="' + waLink('🧵 Hi! Dhoti + Shirt & Saree combo set வேணும் — details & prices அனுப்புங்க 🙏') + '" target="_blank" rel="noopener">💬 WhatsApp-ல் Combo கேளுங்கள்</a>' +
        '<a class="btn btn-outline" style="max-width:340px;margin:8px auto 0" href="shop.html">🛍️ Saree Collection பார்க்க</a></div></div>';
    return;
  }
  const sizeChips = SHIRT_SIZES.map(s =>
    '<button type="button" class="cmb-size' + (__comboSel.shirt === s ? ' on' : '') + '" data-combosize="' + s + '">' + s + '</button>').join('');
  const cardSel = (p) => 'cmb-pick' + (__comboSel.pid === p.id ? ' on' : '');
  const total = sel ? (sel.price || 0) * __comboSel.qty : 0;
  app.innerHTML = '<div class="wrap page">' +
    hero +
    /* step 1 — combo products ONLY */
    '<section class="cmb-sec"><h2>1️⃣ Combo Set-ஐ தேர்ந்தெடுங்கள் <small class="muted">(tap to select)</small></h2>' +
      '<div class="cmb-grid">' + combos.slice(0, 12).map(p =>
    ...
    '<section class="cmb-sec"><h2>2️⃣ Shirt &amp; Dhoti Size <small class="muted">(ஒரே size — shirt &amp; dhoti ரெண்டுக்கும்)</small></h2>' +
      '<div class="cmb-sizes">' + sizeChips + '</div>' +
      '<p class="small muted">S36 • M38 • L40 • XL42 • XXL44 — regular fit shirt + matching readymade dhoti</p></section>' +
    /* step 3 — QUANTITY */
    '<section class="cmb-sec"><h2>3️⃣ Quantity <small class="muted">(combo sets)</small></h2>' +
      '<div class="cmb-qty"><button type="button" data-comboqty="-1" aria-label="Less">−</button><span id="qtyVal">' + __comboSel.qty + '</span><button type="button" data-comboqty="1" aria-label="More">+</button></div>' +
      '<p class="small muted">Need more sets? WhatsApp-ல் bulk combo rate கேளுங்கள்!</p></section>' +
    /* summary + CTA — qty + size ride along in cart & WhatsApp */
    '<div class="cmb-sum">' +
      '<b>📋 Your Combo Order</b>' +
      (sel
        ? '<span>🧵 ' + esc(smartTitle(sel)) + ' — ₹' + (sel.price || 0).toLocaleString('en-IN') + ' × ' + __comboSel.qty + ' = <b>₹' + total.toLocaleString('en-IN') + '</b></span>'
        : '<span>🧵 Combo set: இன்னும் select பண்ணல</span>') +
      '<span>👔 Shirt / Dhoti Size: ' + (__comboSel.shirt || '—') + '</span>' +
      '<span>📦 Quantity: ' + __comboSel.qty + ' set' + (__comboSel.qty > 1 ? 's' : '') + '</span>' +
      /* hidden fields so the standard add-to-cart carries size + qty */
...
document.addEventListener('click', function(e){
  ...
  if (csize){ e.preventDefault(); comboSize(String(csize.dataset.combosize || '')); return; }
  const cq2 = e.target.closest('[data-comboqty]');
  if (cq2){ e.preventDefault(); comboQty(+cq2.dataset.comboqty || 1); return; }
